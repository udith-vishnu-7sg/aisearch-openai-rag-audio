...
echo "AZURE_OPENAI_TTS_DEPLOYMENT=$(azd env get-value AZURE_OPENAI_TTS_DEPLOYMENT 2>/dev/null || echo 'tts-hd')" >> $ENV_FILE_PATH
echo "AZURE_OPENAI_TTS_ENDPOINT=$(azd env get-value AZURE_OPENAI_TTS_ENDPOINT 2>/dev/null || echo '')" >> $ENV_FILE_PATH
echo "AZURE_OPENAI_TTS_API_KEY=$(azd env get-value AZURE_OPENAI_TTS_API_KEY 2>/dev/null || echo '')" >> $ENV_FILE_PATH
